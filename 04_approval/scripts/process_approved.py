...
Usage:
    python 04_approval/scripts/process_approved.py              # all 'approved' rows
    python 04_approval/scripts/process_approved.py --id 5        # one specific row
    python 04_approval/scripts/process_approved.py --limit 1     # cap how many to show
    python 04_approval/scripts/process_approved.py --no-alpaca   # skip live equity lookup
    python 04_approval/scripts/process_approved.py --verbose      # show passing checks too
"""
...
# MAX_SPREAD_PCT is imported from shared.constants (Decimal variant) above.
        ...
        for label, key, threshold in [
            ...
            if pct is None:
                ...
                out.append((CHECK_FAIL,
                            ...
                            f"05_execution/scripts/snapshot_equity.py)"))
                halted = True
                continue
            if pct < -threshold:
                out.append((CHECK_FAIL,
