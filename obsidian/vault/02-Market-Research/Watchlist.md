...
- **AI / Semiconductors:** NVDA, AMD, MU, STX, WDC
- **Data Center / Cloud:** APLD, IREN, NBIS, CIFR
- **Space / Defense:** RKLB, ASTS
- **Nuclear Energy:** OKLO
- **Healthcare:** NVO
- **Robotics:** SERV
- **Social / Tech:** RDDT
...
- **SDSK** was removed — not available on Alpaca
- All stocks stored in both Alpaca watchlist and Postgres `market.assets`
- Prices as of 2026-05-14 close
