...
Usage:
    python 05_execution/scripts/execute_trade.py                       # DRY RUN
    python 05_execution/scripts/execute_trade.py --confirm             # really submit
    python 05_execution/scripts/execute_trade.py --id 7 --confirm
    python 05_execution/scripts/execute_trade.py --limit 3 --confirm
"""
...
# Import shared alert_telegram for notifications
